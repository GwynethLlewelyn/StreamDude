		...
		<div class="container-fluid py-5">
			...
			<nav class="navbar navbar-expand-md navbar-light bg-secondary text-primary fixed-top border-bottom">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href="{{- .URLPathPrefix -}}/admin/files/lua"><i class="bi bi-moon"></i>&nbsp;Lua Scripts</a>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"><i class="bi bi-file-earmark-code"></i>&nbsp;LSL Scripts</a>
							<div class="dropdown-menu bg-primary border shadow-lg">
								<a class="dropdown-item" href="{{- .URLPathPrefix -}}/admin/agent-scripts">Agent Scripts</a>
								<a class="dropdown-item" href="{{- .URLPathPrefix -}}/admin/bot-controller">Bot controller</a>
								<a class="dropdown-item" href="{{- .URLPathPrefix -}}/admin/register-object">Register Object</a>
							</div>
						</li>
						<li class="nav-item dropdown">
						...
						<li class="nav-item">
							<a class="nav-link" href="{{- .URLPathPrefix -}}/admin/credits"><i class="bi bi-info-circle">&nbsp;</i>Credits</a>
						</li>
					</ul>
				</div>
			</nav>
